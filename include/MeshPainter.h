...
public:
    ...
    void bindObjectAndData(TriMesh *mesh, openGLObject &object, const std::vector<std::string>&texture_images, const std::string &vshader, const std::string &fshader);

	void MeshPainter::bindTexture(openGLObject& object, const std::vector<std::string>& texture_images);

	// 添加物体
    void addMesh( TriMesh* mesh, const std::string &name, const std::vector<std::string>& texture_images, const std::string &vshader, const std::string &fshader );
